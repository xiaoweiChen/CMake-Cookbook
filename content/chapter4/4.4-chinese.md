...
Boost测试是在C++社区中，一个非常流行的单元测试框架。本例中，我们将演示如何使用Boost测试，对求和示例代码进行单元测试。

## 准备工作

`main.cpp`、`sum_integers.cpp`和`sum_integers.hpp`与之前的示例相同，将更新`test.cpp`作为对Boost测试库的单元测试：
